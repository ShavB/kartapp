...
public class DbInitializer
{
    public static void InitDb(WebApplication app)
    {
        ...
        var context =
            ...
            ?? throw new InvalidOperationException("Failed to retrieved context data");

        var userManager =
            scope.ServiceProvider.GetRequiredService<UserManager<User>>()
            ?? throw new InvalidOperationException("Failed to retrieved context user manager");
    ...
    public static async Task SeedData(StoreContext context, UserManager<User> userManager)
    {
        ...
        {
            var user = new User { UserName = "johndoe@test.com", Email = "johndoe@test.com" };
